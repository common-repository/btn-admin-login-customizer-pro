...
<style type="text/css">
      ...
      body.page-login:not(.logged-in) input#wp-submit{
        ...
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#loginform .input,
        body.page-login:not(.logged-in) .entry-content form#loginform .input,
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#loginform .input {
        ...
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#loginform #user_pass,
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#loginform #user_login,
        ...
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#loginform #user_pass,
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#loginform #user_login,
    ...
    <script>
        jQuery(document).ready(function () {
            jQuery('body.page-<?php echo $classMaster; ?> form#loginform').before('<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="" tabindex="-1"></a></h1>');
            jQuery('body.page-<?php echo $classMaster; ?> .entry-content').find('br').remove();
            <?php if($classMaster !="login"){ ?>
                jQuery('body.page-login:not(.logged-in) form#loginform').before('<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="" tabindex="-1"></a></h1>');
