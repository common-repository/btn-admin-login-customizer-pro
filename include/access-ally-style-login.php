<?php
/*
    file        :  access-ally-style-login.php
...
<style type="text/css">
      ...
      body.page-login:not(.logged-in) input#wp-submit{
        ...
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 .input,
        body.page-login:not(.logged-in) .entry-content form#accessally-login-form-1 .input,
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 .input {
        ...
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 #user_pass,
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 #user_login,
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form #memb_password_send-1-email-input,
        body.page-login:not(.logged-in) .entry-content form#accessally-login-form-1 #user_pass,
        body.page-login:not(.logged-in) .entry-content form#accessally-login-form-1 #user_login,
        body.page-login:not(.logged-in) .entry-content form #memb_password_send-1-email-input,
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 #user_pass,
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form#accessally-login-form-1 #user_login,
        ...
        body.page-<?php echo $classMaster; ?>:not(.logged-in) .entry-content form .login-submit input[type="submit"],
        ...
        body.page-<?php echo $classforgotMaster; ?>:not(.logged-in) .entry-content form .login-submit input[type="submit"],
    ...
    <script>
        jQuery(document).ready(function () {
            jQuery('body.page-<?php echo $classMaster; ?> form#accessally-login-form-1').before('<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="" tabindex="-1"></a></h1>');
            jQuery('body.page-<?php echo $classMaster; ?> .entry-content').find('br').remove();
            <?php if($classMaster !="login"){ ?>
                jQuery('body.page-login:not(.logged-in) form#accessally-login-form-1').before('<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="" tabindex="-1"></a></h1>');
        ...
        jQuery(document).ready(function () {
            jQuery('body.page-<?php echo $classforgotMaster; ?> form#memb_password_send-1').before('<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="" tabindex="-1"></a></h1>');
